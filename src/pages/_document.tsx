    ...
    return (
      <Html>
        <Head>
          ...
          {/* <!-- Facebook Meta Tags --> */}
          <meta property="og:url" content="https://stream-pay-demo-app.netlify.app" />
          ...
          <meta property="og:image" content="https://stream-pay-demo-app.netlify.app/page.png" />

          {/* <!-- Twitter Meta Tags --> */}
          <meta name="twitter:card" content="summary_large_image" />
          <meta property="twitter:domain" content="stream-pay.netlify.app" />
          <meta property="twitter:url" content="https://stream-pay-demo-app.netlify.app" />
          <meta name="twitter:title" content="Stream Pay" />
          <meta name="twitter:description" content="Stream Pay decentralized application" />
          <meta name="twitter:image" content="https://stream-pay-demo-app.netlify.app/page.png" />
        </Head>
        <body>
          <Main />
          <NextScript />
